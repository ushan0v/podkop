...
NFT_DNS_REDIRECT_CHAIN_NAME="dns_redirect"
...
SB_DNS_REDIRECT_INBOUND_TAG="dns-redirect-in"
SB_DNS_REDIRECT_INBOUND_ADDRESS="0.0.0.0"
SB_DNS_REDIRECT_INBOUND_PORT=1603
